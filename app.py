...
def handle_response_2(json):
    ...
    check = check_if_can_speak(all_messages)
    if check and (
            (ROOM_STATE_TRACKER[room_id]["last_intervention"] >= 4 and ROOM_STATE_TRACKER[room_id]["last_com"] >= 3) or
            ROOM_STATE_TRACKER[room_id]["last_intervention"] >= 6 or len(context) == 4):
